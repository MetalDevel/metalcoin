...
uint256 hashGenesisBlock("0x000007396599b66efbcaa59538e0947a49d8623b6bf69afea9dd67e752556293");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MTC: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MTC Signed Message:\n";
...
{
    // MTC: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 24 * 60 * 60; // MTC: 24 hours
static const int64 nTargetSpacing = 2 * 60; // MTC: 2 minutes
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MTC: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 2 * 60; // MTC: 2 minutes
        static const unsigned int TimeDaySeconds = 2 * 60; // MTC: 2 minutes
...
{
    // MTC: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000007396599b66efbcaa59538e0947a49d8623b6bf69afea9dd67e752556293");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "Metal Coin v2 Launched 1st Oct 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1412175236;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 8464648;
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x801ef6b05e6fadb476898c2819c22ff4a90a453c8582cfd4b3ff63a5bd9a58e4"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // MTC: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MTCMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MTCMiner : ProcessBlock, block not accepted");
    }
